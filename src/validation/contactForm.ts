...
export const ContactSchema = z.object({
  first_name: z.string().min(2, 'Please enter your first name').max(50, 'Keep it under 50 characters'),
  last_name: z.string().min(2, 'Please enter your last name').max(50, 'Keep it under 50 characters'),
...
export type Contact = Omit<ContactInput, "hp"> & Partial<Pick<ContactInput, "hp">>
